...
int buzzerPin= 2;// Buzer
int echoPin= 6;// Utra sonic
int trigPin= 5; // Utra sonic
int minDistance = 100;// Utra sonic
int maxDistance = 300;
...
void loop()
{
  ...
  if(ledsToGlow == 12)
  {
    digitalWrite(buzzerPin, HIGH);  // When 12 led is lighting
  }
